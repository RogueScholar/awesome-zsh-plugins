...
[ZSH](http://www.zsh.org/) similar to vim-plug. ZPM plugins are compatible with
[oh-my-zsh](http://ohmyz.sh/). ZPM runs on Linux, macOS, FreeBSD and Android.
...
- [ZSH Gem 24](https://www.refining-linux.org/archives/59/ZSH-Gem-24-ZSH-frameworks/) -
...
- [tag-search](https://github.com/zdharma/zsh-tag-search) - A history search
  tool for Zsh aimed at tag-marking history entries with support for regular
  search.
