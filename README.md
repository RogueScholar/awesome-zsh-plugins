...
- [kubectl-zsh-plugin](https://github.com/mattbangert/kubectl-zsh-plugin) - ZSH
  plugin for managing `kubectl`.
...
- [eriner](https://github.com/zimfw/eriner) - A Zim fork of the
  Powerline-inspired agnoster prompt theme. Includes `git` status decorations.
