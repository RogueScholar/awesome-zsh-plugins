...
[crasis](https://github.com/zdharma/zplugin-crasis) or
...
- [zinit-configs](https://github.com/zdharma/zinit-configs) - Real-world
  configuration files (basically a collection of `.zshrc` files) holding Zplugin
  invocations.
...
- [jq-zsh-plugin](https://github.com/reegnz/jq-zsh-plugin) jq-repl with line
...
- [vi-quote](https://github.com/zsh-vi-more/vi-quote) - Adds an operation which
...
- [zinit-console](https://github.com/zinit-zsh/zinit-console) – a semigraphical
  (curses) consolette for [zinit](#zinit)
