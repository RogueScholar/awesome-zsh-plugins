...
[fzf-marks](https://github.com/popstas/urbainvaes/fzf-marks). Fully
customizable.
...
is to have a minimal overhead when starting up the shell because nobody likes
waiting. The script generates a static `init.zsh` file which does nothing but
source your plugins and append them to your `fpath`. This saves startup time by
not having to execute time consuming logic (plugin checking, updates, etc). The
downside is that you have to refresh the init script manually with `zgen reset`
whenever you update your `.zshrc`. Can load
...
**Zplugin** is an innovative plugin manager with
[semigraphical UI](https://github.com/zdharma/zplugin-crasis),
[Turbo Mode](http://zdharma.org/zplugin/wiki/INTRODUCTION/#turbo_mode_zsh_62_53),
a clean fpath, reports, completion management and
...
commands in your `~.zshrc` and also use
[zplugin-console](https://github.com/zplugin/zplugin-console) to view and change
the state of the Zsh session and to delete the plugins and snippets from the
disk. The project is very active – currently > 2000 commits.
...
- [zsh-quickstart-kit](https://github.com/unixorn/zsh-quickstart-kit) - A simple
  ...
  includes a curated collection of plugins, and will automatically configure ZSH
  to use [zgen](https://github.com/tarjoilija/zgen) to load them, configures
  [zgen](https://github.com/tarjoilija/zgen) to periodically automatically
  update itself, the plugins, and the quickstart kit itself.

### Zplugin

- [BlaCk-Void-Zsh](https://github.com/black7375/BlaCk-Void-Zsh) - :crystal_ball:
  Awesome, Customable Zsh Starter Kit :stars::stars:
- [zplugin-configs](https://github.com/zdharma/zplugin-configs) - Real-world
  configuration files (basically zshrc-s) holding Zplugin invocations.
...
- [completion-generator](https://github.com/RobSis/zsh-completion-generator) -
  ...
  completion script.
- [containerized-gradle](https://github.com/hermitmaster/containerized-gradle) -
  A plugin that adds containerized Gradle commands to ZSH.
- [containerized-maven](https://github.com/hermitmaster/containerized-maven) - A
  plugin that adds containerized Maven commands to ZSH.
...
- [node](https://github.com/srijanshetty/node.plugin.zsh) - Srijan Shetty's
  ...
  `nvm` if present.
- [nodenv](https://github.com/jsahlen/nodenv.plugin.zsh) - Auto-load `nodenv`
...
- [nonotes](https://github.com/stevemcilwain/nonotes) - Plugin for pen-testing.
  No more notes needed, no more copy and paste of commands.
...
- [schroot](https://github.com/fshp/schroot.plugin.zsh) - Show current `chroot`
  name in your prompt.
- [sdkman](https://github.com/hermitmaster/sdkman) - A plugin that adds SDKMAN!
  to ZSH.
...
- [vagrant-box](https://github.com/evanthegrayt/vagrant-box-wrapper) - wrapper
  plugin for [vagrant](https://www.vagrantup.com/) that allows for calling
  vagrant commands from outside of the box directory. The plugin also ships with
  a few extra commands that help to manage more than one box, along with custom
  tab-completion
...
- [z-a-bin-gem-node](https://github.com/zplugin/z-a-bin-gem-node) - Zplugin
...
- [z-a-man](https://github.com/zplugin/z-a-man) - Zplugin extension that
  generates man pages for all plugins and snippets.
- [z-a-patch-dl](https://github.com/zplugin/z-a-patch-dl) - Zplugin extension
  that downloads files and applies patches through the provided `dl''` and
  `patch''` ices.
- [z-a-rust](https://github.com/zplugin/z-a-rust) - Zplugin extension that that
  installs rust and cargo packages inside plugin directories.
- [z-a-test](https://github.com/zplugin/z-a-test) - Zplugin extension that runs
...
- [zplugin-console](https://github.com/zplugin/zplugin-console) – a
  semigraphical (curses) consolette for [Zplugin](#zplugin)
...
- [test-kitchen-zsh-plugin](https://github.com/pelletiermaxime/test-kitchen-zsh-plugin) -
  Add completions for [Test Kitchen](https://kitchen.ci/).
...
- [yarn](https://github.com/g-plane/zsh-yarn-autocompletions) - Add
  autocompletions for `yarn add`, `yarn remove` and `yarn run`.
...
- [bandit](https://github.com/Holger-Will/zsh_bandit) - Another Powerline
  variant.
- [bar (anki-code)](https://github.com/anki-code/zsh-bar-theme) - Colorful
  theme, includes `git` decorations and active conda version.
- [bar (xp-bar)](https://github.com/xp-bar/zsh-bar-theme) - Includes username,
...
- [linuxer](https://github.com/patrick330602/linuxer) - Inspired by Yaris Alex
  Gutierrez's classyTouch, Yad Smood's ys, and Bureau theme.
...
- [mindful-space](https://github.com/syndbg/mindful-space-zsh-theme) - ZSH theme
  with space in mind.
- [minima](https://github.com/eduardnikolenko/minima) - A minimal ZSH theme with
  `git`, `docker`, `go`, `node`, `npm`, `python` and other indicators. Uses
  unicode characters for some markers.
...
- [slimline](https://github.com/mgee/slimline) - Minimal, fast and elegant ZSH
