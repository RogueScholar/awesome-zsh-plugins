...
- [last-working-directory (mdumitru)](https://github.com/mdumitru/last-working-dir) -
  Broken out version of the version in [oh-my-zsh](http://ohmyz.sh/) so users of
  other frameworks don't have to import all of OMZ.
...
- [nix-shell](https://github.com/chisui/zsh-nix-shell) - Plugin that lets you
  use ZSH as the default `nix-shell` shell.
...
- [symfony](https://github.com/voronkovich/symfony.plugin.zsh) - ZSH plugin for
  Symfony 2 and 3.
...
- [extract](https://github.com/thetic/extract) - Fork of the oh-my-zsh extract
  plugin.
