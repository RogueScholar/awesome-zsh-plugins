...
- [tig](https://github.com/zdharma/zsh-tig-plugin) - Automatically adds a few
  advanced bindings and also provides a ZSH-rewritten function and/or script
  `tig-pick`.
...
- [haxelib](https://github.com/tong/zsh.plugin.haxelib) - Completions for
  haxelib.
- [ipfs](https://github.com/aramboi/zsh-ipfs) - Completions for the
...
- [aaron](https://github.com/aaronjamesyoung/aaron-zsh-theme) - Based on the
  Sorin theme.
- [abbr](https://github.com/PhilsLab/abbr-zsh-theme) - Displays an abbreviated
  version of the current directory path, shows the Python virtualenv, Rust
  version, `git` status, and the exit code of last command. Works well on dark
  backgrounds by default but colors can be easily customized.
...
- [alpharized](https://github.com/NicoSantangelo/Alpharized) - modified version
  of the
  [avit](https://github.com/robbyrussell/oh-my-zsh/blob/master/themes/avit.zsh-theme)
  theme optimized to work with
  [solarized dark](https://github.com/altercation/solarized) terminals.
...
- [astral](https://github.com/alphabetum/astral) - Theme for dark backgrounds
  with zen mode.
...
- [minimal](https://github.com/subnixr/minimal) - Minimal yet feature-rich
  theme.
...
- [smiley](https://github.com/gsamokovarov/smiley.zsh-theme) - A prompt with
  happy and sad faces.
- [snakypy](https://github.com/snakypy/snakypy-prompt) - Focused on the needs of
  [Python](https://www.python.org/) developers. Displays `git` and `venv` status
  decorations. Includes an installer script.
